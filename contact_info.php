...
<head>
    ...
    .content {
        ...
        box-shadow: 0 2px 20px rgba(255, 204, 0, 0.4); /* Neon shadow */
        position: relative;
        color: white;
    }
    ...
    .profile-picture {
        ...
        top: 20px;
        right: 20px;
        box-shadow: 0 4px 10px rgba(255, 204, 0, 0.4); /* Soft neon shadow */
    }
    ...
    .back-button {
        ...
        font-weight: bold;
        text-align: center;
        box-shadow: 0 4px 10px rgba(255, 204, 0, 0.4); /* Glow effect */
    }
