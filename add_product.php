...
<head>
    ...
    body {
        ...
        background-color: black; /* Soft brown and beige gradient */
    ...
    h2 {
        text-align: center;
        color: white; /* Gold for headings */
        text-shadow: 0 0 8px rgba(255, 204, 0, 0.5); /* Neon glow effect */
    }

    form {
        background-color: white; /* Dark brown background */
        border-radius: 10px;
    ...
    label {
        ...
        margin-bottom: 8px;
        font-weight: bold;
        color: black; /* Subtle grey for labels */
    }
    ...
    button {
        background-color: black; /* Gold button */
    ...
    button:hover {
        background-color: lightgreen; /* Lighter brown on hover */
