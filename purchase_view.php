...
<head>
    ...
    <style>
        /* General body style */
        body {
            background: black; /* Soft Brown and Beige Gradient */
            color: #E0E0E0;
        ...
        /* Header styling */
        header {
            background: grey; /* Light brown gradient */
            color: #121212;
            padding: 20px;
            text-align: center;
            font-size: 28px;
        ...
        nav a:hover {
            color: black;
            background-color: lightgreen; /* Darker brown hover effect */
            border-radius: 5px;
        ...
        tr:hover {
            background-color: lightgreen; /* Darker row hover */
        }
                ...
                <table>
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><a href="contact_info.php?client_id=<?= htmlspecialchars($row['client_id']) ?>" style="color: #F4D03F;">View Details</a></td>
                        </tr>
                    <?php endwhile; ?>
                </table>
