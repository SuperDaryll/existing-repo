...
<head>
    ...
    header {
        ...
        text-align: center;
        font-size: 24px;
        box-shadow: 0 4px 10px rgba(255, 204, 0, 0.4); /* Neon shadow */
        text-shadow: 0 0 8px rgba(255, 204, 0, 0.4); /* Glow effect */
    }
    ...
    nav {
        ...
        overflow: hidden;
        box-shadow: 0 4px 10px rgba(255, 204, 0, 0.4); /* Subtle shadow */
    }
    ...
    .product-card {
        ...
        overflow: hidden;
        text-align: center;
        box-shadow: 0 4px 10px rgba(255, 204, 0, 0.4); /* Subtle neon shadow */
    ...
    .product-card:hover {
        ...
        box-shadow: 0 6px 15px lightgreen; /* Enhanced shadow */
    }
    ...
    .buy-button {
        ...
        box-shadow: 0 4px 8px rgba(255, 204, 0, 0.4); /* Glow effect */
    }

    .buy-button:hover {
        background-color: lightgreen; /* Darker neon blue on hover */
        box-shadow: 0 6px 12px rgba(255, 204, 0, 0.4); /* Enhanced glow on hover */
    }
