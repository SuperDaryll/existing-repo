...
<head>
    ...
    header {
        ...
        font-weight: bold;
        text-shadow: 0 0 10px rgba(255, 204, 0, 0.4); /* Glowing text */
        box-shadow: 0 6px 15px rgba(255, 204, 0, 0.4); /* Neon glow shadow */
    }
    ...
    .content {
        ...
        box-shadow: 0 4px 12px rgba(255, 204, 0, 0.4); /* Neon glow shadow */
    ...
    input[type="submit"] {
        padding: 12px 18px;
        background-color: gold; /* Neon blue background */
        color: black;
        border: none;
        border-radius: 8px;
        font-size: 18px;
        cursor: pointer;
        box-shadow: 0 3px 6px rgba(255, 204, 0, 0.4); /* Glow effect */
        transition: background-color 0.3s, transform 0.3s;
    }

    input[type="submit"]:hover {
        background-color: lightgreen; /* Darker blue on hover */
        transform: translateY(-2px); /* Slight lift effect */
        box-shadow: 0 4px 10px rgba(255, 204, 0, 0.4); /* Enhanced glow */
    }

    /* Link styling */
    a {
        color: gold; /* Neon blue text for links */
    ...
    a:hover {
        color: lightgreen; /* Hover effect on links */
    }
