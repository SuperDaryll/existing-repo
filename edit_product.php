...
<head>
    ...
    h3, h4 {
        ...
        text-shadow: 0 0 8px rgba(255, 204, 0, 0.4); /* Neon glow */
    }

    form {
        background-color: #1E1E1E; /* Dark form background */
        border-radius: 12px;
        box-shadow: 0 4px 20px rgba(255, 204, 0, 0.4); /* Soft neon blue shadow */
        padding: 20px;
        max-width: 400px;
        margin: auto;
        color: #E0E0E0;
    ...
    textarea {
        ...
        color: #E0E0E0;
        box-shadow: inset 0 0 5px rgba(255, 204, 0, 0.4); /* Soft inner glow */
    }
    ...
    textarea:focus {
        outline: none;
        border-color: #00E5FF;
        box-shadow: 0 0 8px rgba(255, 204, 0, 0.4); /* Outer glow */
    }
    ...
    button {
        background-color: gold; /* Neon blue button */
        ...
        font-weight: bold;
        font-size: 16px;
        box-shadow: 0 4px 10px rgba(255, 204, 0, 0.4); /* Soft neon glow */
        transition: background-color 0.3s ease, box-shadow 0.3s ease;
    }

    button:hover {
        background-color: lightgreen; /* Slightly darker blue on hover */
        box-shadow: 0 6px 15px rgba(255, 204, 0, 0.4); /* Enhanced glow on hover */
    }
